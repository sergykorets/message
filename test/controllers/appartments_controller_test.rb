...
class AppartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appartment" do
    assert_difference('Appartment.count') do
      post appartments_url, params: { appartment: { address: @appartment.address, rent: @appartment.rent } }
    end
  ...
  test "should update appartment" do
    patch appartment_url(@appartment), params: { appartment: { address: @appartment.address, rent: @appartment.rent } }
